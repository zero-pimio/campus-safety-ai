...
[在线视频展示页](https://zero-pimio.github.io/campus-safety-ai/)现提供打架、新跌倒、人员入侵及两段 URFD 历史演示，共 5 段，可播放和下载。各视频按各自来源条款使用，见[素材署名与许可](../../exports/github-pages-showcase/README.md)。车辆新视频暂为本地演示；两项闯卡能力尚无运行视频。

仓库不分发第三方原片集合、完整推理缓存或新候选权重。要重新推理，请从作者来源取得适合自身用途的素材，再在本地运行；仓库代码许可不扩大素材、模型的许可范围。下方 `runtime/...` 均为命令将生成的本地路径，不是 GitHub 下载地址。
